...
testthat::test_that("ngr_cite_keys_to_xref runs and returns data.frame", {
  result <- suppressWarnings(
    ngr_cite_keys_to_xref(citation_keys, bib_file, key_abort_on_missing = FALSE, key_check_response = FALSE)
  )
...
testthat::test_that("ngr_cite_keys_to_xref aborts with missing keys", {
  expect_error(
    suppressWarnings(
      ngr_cite_keys_to_xref(citation_keys, bib_file, key_abort_on_missing = TRUE, key_check_response = FALSE)
      ),
...
testthat::test_that("ngr_cite_keys_to_xref throws a warning when key_abort_on_missing is FALSE", {
  ...
  expect_warning(
      ngr_cite_keys_to_xref(citation_keys, bib_file, key_abort_on_missing = FALSE)
  )
